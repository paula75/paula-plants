...
DEVICE="/dev/mmcblk0"       # source and target SD card device
USER=${USER:-`whoami`}            # linux user name
IMAGE_NAME="sd_image"          # image name, alternative with date and time: "image_$(date +"%y%m%d%H%M%S")"
